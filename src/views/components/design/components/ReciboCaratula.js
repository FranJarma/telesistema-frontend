  ...
  <Document>
    <Page size="A4" style={styles.page}>
      <View>
        ...
        <View style={styles.row}>
          <Text style={styles.subtitle}>En concepto de: <Text style={styles.subtitleSpan}>{data.MovimientoConceptoNombre} - {data.ServicioAbonado ? data.ServicioAbonado.ServicioNombre : data.ServicioNombre}</Text></Text>
        </View>
        <View style={styles.row}>
          <View style={styles.column}>
